            ...
            {batchProgress && (
              <div className="mt-3">
                <Progress
                  ...
                  status="active"
                  format={() => `(${batchProgress.current}/${batchProgress.total}) ${batchProgress.fileName}`}
                />
              </div>
            )}
            <Text type="secondary" className="block mt-2 text-xs">
              支持格式: Markdown、PDF、PPT/PPTX、Word、图像(JPG/PNG)、文本文件 | 支持多选批量上传
            </Text>
          </Card>
        </div>
